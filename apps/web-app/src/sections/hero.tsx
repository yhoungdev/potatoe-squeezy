    ...
    <div className="">
      ...
      <div className="items-center flex mt-[2em] justify-center h-[80vh]">
        <div className="w-[90%] lg:w-[600px] mx-auto text-center">
          ...
          <h1 className="text-3xl font-bold">GitHub Just Got Starchier — Turn Potatoes into Bitcoin!</h1>
          ...
          <a href="https://github.com/yhoungdev/potatoe-squeezy" target="_blank" rel="noopener noreferrer">
            <button className="bg-orange-500 text-white px-4 py-2 w-[150px]">Get Start</button>
          </a>
        </div>
      </div>
    </div>
