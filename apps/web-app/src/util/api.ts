...
class ApiClient {
    private static readonly baseUrl = import.meta.env.NEXT_PUBLIC_API_URL || 'http://localhost:3000';
    ...
    static async post<T>(path: string, data?: Record<string, string>): Promise<T> {
